...
{
    @javafx.fxml.FXML
    private TableColumn numberOfCarryOnBags;
    @javafx.fxml.FXML
    private TableColumn bagContentsColumn;
    @javafx.fxml.FXML
    private TableColumn luggageTypesColumn;
    @javafx.fxml.FXML
    private TableView luggageInfoTableView;
    @javafx.fxml.FXML
    private TableColumn totalNumberOfBagsColumn;
