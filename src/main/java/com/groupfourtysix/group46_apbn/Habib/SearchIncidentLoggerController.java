...
public class SearchIncidentLoggerController
{
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    private TextField SearchIncidentLoggerField;
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void SearchIncidentButton(ActionEvent actionEvent) {
        List<IncidentLogger> filtered = new ArrayList<>();
        boolean filterFlag = false;

        for (IncidentLogger incidentLogger: incidentLoggers){
            if (incidentLogger.getIncidentID().equalsIgnoreCase(SearchIncidentLoggerField.getText())){
